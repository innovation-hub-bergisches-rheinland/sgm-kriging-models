...
class TestModelPredictionService(unittest.TestCase):
    ...
    def test_predict_all(self):
        response: tf.TargetFunctions = self.model_predictions.predict_all(
            self.example_input)
        self.assertAlmostEqual(response.cycle_time, 58.290404007574885, 10)
        self.assertAlmostEqual(response.avg_volume_shrinkage, 10.310196175894047, 10)
        self.assertAlmostEqual(response.max_warpage, 0.36341738225264736, 10)
